...
function WelcomePage() {
  return (
    <div>
         <div
      className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br md:ml-96"
    >
      <div
        className="bg-white rounded-lg p-8 w-full max-w-lg flex flex-col items-center space-y-8 md:flex-row-reverse"
      > 
        <div className="flex flex-col items-center space-y-4 md:flex-row-reverse">
          ...
          <div className="div1 w-96">
            <h1
              className="text-2xl mt-8 font-bold text-gray-800 text-center md:font-semibold md:text-5xl"
            >
              Hi, Welcome Back!
            </h1>
